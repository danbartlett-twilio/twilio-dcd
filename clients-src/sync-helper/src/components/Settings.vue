  ...
  export default {
    ...
    setup() {
      ...
      const getEnvironmentVariables = async () => {
        ...
        try {
            let url = `${import.meta.env.VITE_DATA_URL}/sync/system/return-all-variables`;            
...
<template>
  <div class="container pt-3">
    <h1 class="mb-5">Sync Helper > Settings</h1>

    <p class="fs-5">
      Sync Helper needs a Sync Service. The SID for the Sync Service is stored as 
