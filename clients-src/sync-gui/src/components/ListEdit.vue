  ...
  export default {
    setup() {
      ...
      const createList = async() => {
        ...
        let url = `${import.meta.env.VITE_DATA_URL}/sync/list-create?uniqueName=${pageObject.listName}`;
        ...
        if (res.ok) {
          ...
          // #4 Add a item into the Sync TwilioTableMain for new List
          url = `${import.meta.env.VITE_DATA_URL}/sync/list-item-create?targetList=${syncStore.twilioTableSID}`;          
          let payload = {
      ...
      const saveNewItemObject = async (p) => {
        ...
        let url = `${import.meta.env.VITE_DATA_URL}/sync/list-item-create?targetList=${pageObject.listSid}`;
      ...
      const deleteListFn = async() => {
        ...
        // #1 Delete the List
        let url = `${import.meta.env.VITE_DATA_URL}/sync/list-delete?listSid=${pageObject.listName}`;
        const res = await fetch(url, { method: "POST", headers: {'Content-type': 'application/json'} });
        ...
        if (res.ok) {
          ...
          let url = `${import.meta.env.VITE_DATA_URL}/sync/list-item-delete?targetList=${syncStore.twilioTableSID}&listItemIndex=${pageObject.listItemIndex}`;
          const res = await fetch(url, { method: "POST", headers: {'Content-type': 'application/json'} });
          if (res.ok) {
      ...
      const updateList = async() => {
        ...
        let url = `${import.meta.env.VITE_DATA_URL}/sync/list-item-update?targetList=${syncStore.twilioTableSID}`;
      ...
      const getListData = async() => {
        ...
        let url = `${import.meta.env.VITE_DATA_URL}/sync/list-item-get-array?targetList=${syncStore.twilioTableSID}&ts=${Date.now()}`;
