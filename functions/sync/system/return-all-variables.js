...
const tsh = require(Runtime.getFunctions()['sync/system/twilio-service-helper'].path);

// ADD Helper file to consistently format response header
const rsp = require(Runtime.getFunctions()['sync/system/format-response-headers'].path);
